...
(function() {
  ...
  Rivets.Binding = (function() {
    ...
    function Binding(el, type, model, keypath, options) {
      ...
      this.formattedValueFromView = __bind(this.formattedValueFromView, this);
    ...
    Binding.prototype.publish = function() {
      var value;
      value = this.formattedValueFromView(getInputValue(this.el));
      return Rivets.config.adapter.publish(this.model, this.keypath, value);
    };

    Binding.prototype.formattedValueFromView = function(value) {
